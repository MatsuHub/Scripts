...
-- Botão de Ação (Aparece nos Checkpoints)
...
ActionBtn.MouseButton1Click:Connect(function()
    ...
    if ActionBtn.Text == "DESCER" and h then
        ...
        task.wait(0.5)
        faseFinal = true -- Libera para voar de novo até a areia
